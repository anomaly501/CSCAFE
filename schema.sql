-- CSPOINT Database Schema
-- Run: psql -U postgres -f schema.sql

CREATE DATABASE cspoint;
\c cspoint;
...
('CSIR CSMCRI Summer Internships 2026', 'Central Salt and Marine Chemicals Research Institute internship and training program.', 'Internship', '2026-02-17', 'https://www.csmcri.res.in/internship-training-program', 'https://www.csmcri.res.in/internship-training-program', 'CSPOINT Team', 2),
('CSIR CFTRI Summer Internships 2026', 'Central Food Technological Research Institute internship for food science students.', 'Internship', '2026-02-17', 'https://cftri.res.in/internship', 'https://cftri.res.in/internship', 'CSPOINT Team', 2),
('National Institute of Oceanography Internships 2026', 'NIO offers internship positions for students from science and engineering backgrounds.', 'Internship', '2026-02-17', 'https://www.nio.res.in/human-resource/students/interns', 'https://www.nio.res.in/human-resource/students/interns', 'CSPOINT Team', 2),
('NITI Aayog Internships 2026', 'NITI Aayog internship for students in policy research and governance.', 'Internship', '2026-02-16', 'https://www.niti.gov.in/internship', 'https://www.niti.gov.in/internship', 'CSPOINT Team', 2),
('ISRO MCF Summer Internships 2026', 'ISRO Master Control Facility summer internship. Satellite operations experience.', 'Internship', '2026-02-16', 'https://www.mcf.gov.in/website/Internship', 'https://www.mcf.gov.in/website/Internship', 'CSPOINT Team', 2),
